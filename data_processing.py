...
def call_shuffle_on_file(path_to_files, path_to_put, n_files_to_split, shuffles = 2):
...
def shuffle_files(path_to_files, path_to_put, n_files_to_split = 20):
    call_shuffle_on_file(path_to_files, path_to_put, n_files_to_split)
...
if __name__ == "__main__":
    ...
    shuffle_files(path_to_processed_train, path_to_put, n_files_to_split=3)
